...
| F11c | โหมดเก็บพิกัด GPS แบบไม่มีแผนที่ — เปิดเร็ว กินแบตน้อย เห็นค่าจากเครื่องรับครบ (ความเร็ว ทิศทาง อายุ fix) เก็บลงชุดข้อมูลเดียวกับโหมดแผนที่ |
| F12 | ปักจุดอันตราย (หมา / ทางข้าม / น้ำท่วม / ไม่มีไฟ …) แล้วเตือนล่วงหน้าเมื่อเดินเข้าใกล้ ทั้งข้อความบนจอและเสียงพูดภาษาไทย + บอกล่วงหน้าว่าเส้นทางที่วางไว้ผ่านจุดอันตรายกี่จุด |
...
| [docs/HAZARDS.md](docs/HAZARDS.md) | จุดอันตราย กติกาการเตือน และเสียงพูดภาษาไทย |
