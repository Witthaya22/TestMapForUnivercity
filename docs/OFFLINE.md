...
|---|---|---|---|---|
| ดาวน์โหลดครั้งแรก (ค่าเริ่มต้น) | `TileSourceMode.OFFLINE_PACK` | ครั้งแรกครั้งเดียว | 15–40 MB (ในเครื่อง) | ผู้ใช้ทั่วไป |
| ฝังมากับแอป | `TileSourceMode.BUNDLED` | ไม่ต้องเลย | +15–40 MB ใน APK | แจกในที่ไม่มีเน็ต / เผื่อ OpenFreeMap ปิดบริการ |
...
```
พื้นที่ ~4 ตร.กม. ที่ z13–18 ใช้ tile ประมาณ 10,000–20,000 ใบ
ถ้าไม่ตั้ง จะโดน `mapboxTileCountLimitExceeded` แล้วดาวน์โหลดค้างกลางทางโดยไม่บอกสาเหตุชัด ๆ
